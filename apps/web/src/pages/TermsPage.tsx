      ...
      <div className="prose prose-invert prose-zinc max-w-none text-muted-foreground space-y-8 bg-panel/30 p-8 md:p-12 rounded-2xl border border-border shadow-sm">
        <section>
          <h2 className="text-2xl font-bold text-foreground mb-4 flex items-center gap-3">
            <span className="flex items-center justify-center w-8 h-8 rounded-full bg-brand/20 text-primary text-sm">1</span>
            Acceptance of Terms
          </h2>
          <p className="leading-relaxed">By accessing and using ValorFitness services, you accept and agree to be bound by the terms and provision of this agreement. These terms apply to all visitors, users, and others who access or use our facilities and services.</p>
        </section>
        
        <section>
          <h2 className="text-2xl font-bold text-foreground mb-4 flex items-center gap-3">
            <span className="flex items-center justify-center w-8 h-8 rounded-full bg-brand/20 text-primary text-sm">2</span>
            Gym Memberships & Usage
          </h2>
          <p className="leading-relaxed">Memberships are strictly non-transferable. Members must adhere to the gym's code of conduct, which includes respecting equipment, staff, and other members. ValorFitness reserves the right to terminate memberships for violations of these policies.</p>
        </section>
        
        <section>
          <h2 className="text-2xl font-bold text-foreground mb-4 flex items-center gap-3">
            <span className="flex items-center justify-center w-8 h-8 rounded-full bg-brand/20 text-primary text-sm">3</span>
        ...
        <section>
          <h2 className="text-2xl font-bold text-foreground mb-4 flex items-center gap-3">
            <span className="flex items-center justify-center w-8 h-8 rounded-full bg-brand/20 text-primary text-sm">4</span>
