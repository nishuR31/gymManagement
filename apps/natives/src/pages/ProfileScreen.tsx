...
import { UserRound, LogOut, ShieldCheck, Mail, KeyRound, Smartphone, Activity, Flame, SwitchCamera } from 'lucide-react-native';
...
export function ProfileScreen() {
  ...
  const [_loadingMember, setLoadingMember] = useState(false);
