...
import { Beef, ClipboardList, Dumbbell, Timer, UserRound, X } from 'lucide-react-native';
...
function AssignModal({ kind, templates, trainerProfiles, onClose, activeColors }: any) {
