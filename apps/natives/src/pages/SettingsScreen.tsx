...
export function SettingsScreen() {
  ...
  return (
    <ScreenWrapper>
      ...
      <Card className="mb-4">
        <CardHeader>
          <CardTitle>UI Styling & Theme</CardTitle>
        </CardHeader>
        <CardContent>
          <View className="mb-6">
            <Button
              variant="secondary"
              onPress={() => {
                const next = theme === 'light' ? 'dark' : theme === 'dark' ? 'amoled' : theme === 'amoled' ? 'system' : 'light';
                dispatch(setTheme(next));
              }}
              className="w-full flex-row justify-center py-3 border border-border"
            >
              {theme === 'amoled' ? (
                <View className="flex-row items-center"><MoonStar size={18} color={colors.foreground} /><Text style={{ color: colors.foreground }} className="ml-2 font-bold">Theme: AMOLED</Text></View>
              ) : theme === 'dark' ? (
                <View className="flex-row items-center"><Moon size={18} color={colors.foreground} /><Text style={{ color: colors.foreground }} className="ml-2 font-bold">Theme: Dark</Text></View>
              ) : theme === 'system' ? (
                <View className="flex-row items-center"><MonitorSmartphone size={18} color={colors.foreground} /><Text style={{ color: colors.foreground }} className="ml-2 font-bold">Theme: System Default</Text></View>
              ) : (
                <View className="flex-row items-center"><Sun size={18} color={colors.foreground} /><Text style={{ color: colors.foreground }} className="ml-2 font-bold">Theme: Light</Text></View>
              )}
            </Button>
          </View>
