...
export interface InventoryAggregateCache {
...
export class RedisInventoryAggregateCache implements InventoryAggregateCache {
...
export class NullInventoryAggregateCache implements InventoryAggregateCache {
