...
export interface AttendanceAggregateCache {
...
export class RedisAttendanceAggregateCache implements AttendanceAggregateCache {
...
export class NullAttendanceAggregateCache implements AttendanceAggregateCache {
